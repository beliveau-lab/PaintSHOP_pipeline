...
df = pd.read_csv('/home/conor/workspace/PaintSHOP_pipeline/example_run/pipeline_output/02_intermediate_files/06_data_frames/chrI_alignments.csv')
...
# /home/conor/workspace/PaintSHOP_pipeline/workflow/pickled_models/37_all_fixed_xgb.pickle.dat
...
df.to_csv('TESTING_XGBOOST_PREDICTIONS.csv', index_label=False)
